...
export default function Plans({}: Props) {
  return (
    ...
    viewport={{once: true}} className="flex flex-col relative h-screen text-lft overflow-hidden md:text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center">
        ...
        <div className="flex flex-nowrap space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#0a65f7]/80 mx-auto">
            < PlansCard/>
            < PlansCard />
            < PlansCard />
            < PlansCard />
